...
FPVM_MATH_DECL(f2i, double) {
    ...
    switch (special->byte_width) {
        case 1: *(int8_t*)src2 = value; break;
        case 2: *(int16_t*)src2 = value; break;
        case 4: *(int32_t*)src2 = value; break;
        case 8: *(int64_t*)src2 = value; break;
        default:
...
FPVM_MATH_DECL(f2u, double) {
    double value = decode_to_double(src1);
    switch (special->byte_width) {
        case 1: *(uint8_t*)src2 = value; break;
        case 2: *(uint16_t*)src2 = value; break;
        case 4: *(uint32_t*)src2 = value; break;
        case 8: *(uint64_t*)src2 = value; break;
        default:
        ERROR("Cannot handle double->signed(%d)\n",special->byte_width);
        return -1;
        break;
...
int f2f_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) {
    double value = decode_to_double(src1);
    switch (special->byte_width) {
        case 4: *(float*)src2 = value; break;
        case 8: *(double*)src2 = value; break;
        default:
