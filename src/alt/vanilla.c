...
int vanilla_##NAME##_##TYPE(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) \
{									\
...
static inline double maxd(double a, double b) { if (a>b) { return a; } else {return b;} }
static inline double mind(double a, double b) { if (a<b) { return a; } else {return b;} }
static inline float  maxf(float a, float b) { if (a>b) { return a; } else {return b;} }
static inline float  minf(float a, float b) { if (a<b) { return a; } else {return b;} }
...
/*   DEBUG("sqrt_double: sqrt(%lf) = %lf [%016lx] (%p)\n", *(double*)src1, result, *(uint64_t*)&result, dest ); */
/*   *(double*)dest = result; */
/*   return 0; */
/* } */
...
/*   DEBUG("sqrt_single: sqrt(%f) = %f [%08x] (%p)\n", *(float*)src1,result, *(uint32_t*)&result, dest ); */
/*   *(float*)dest = result; */
/*   return 0; */
/* } */

// We assume in the following that C converstion float to int will do truncation
// Intel truncating convert instructions assume indefinite result 0x8000.... when overflowing
// Intel non-truncating converst instructions don't really specify what they do when overflowing
// We need to either find better documentation of the instructions or test them...
// the current version of the following does the C conversion in all cases.
// 
...
int vanilla_f2i_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) 
{
  switch (special->byte_width) {
  case 1: CONVERT_F2I(double,int8_t,"%lf","%hhd");
  case 2: CONVERT_F2I(double,int16_t,"%lf","%hd");
  case 4: CONVERT_F2I(double,int32_t,"%lf","%d");
  case 8: CONVERT_F2I(double,int64_t,"%lf","%ld");
  default:
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_f2u_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
  case 1: CONVERT_F2I(double,uint8_t,"%lf","%hhu");
  case 2: CONVERT_F2I(double,uint16_t,"%lf","%hu");
  case 4: CONVERT_F2I(double,uint32_t,"%lf","%u");
  case 8: CONVERT_F2I(double,uint64_t,"%lf","%lu");
  default:
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_f2i_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) 
{
  switch (special->byte_width) {
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_f2u_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
...
#define CONVERT_I2F(FTYPE,ITYPE,FSPEC,ISPEC)  { \
    ...
    DEBUG("i2f[" #ITYPE " to " #FTYPE "](" #ISPEC ") = " #FSPEC " (%p)\n", (*(ITYPE *)src1),result,dest); \
    *(ITYPE*)dest = result; \
    return 0; \
}

// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_i2f_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) 
{
  switch (special->byte_width) {
  case 1: CONVERT_I2F(double,int8_t,"%lf","%hhd");
  case 2: CONVERT_I2F(double,int16_t,"%lf","%hd");
  case 4: CONVERT_I2F(double,int32_t,"%lf","%d");
  case 8: CONVERT_I2F(double,int64_t,"%lf","%ld");
  default:
    ERROR("Cannot handle double->signed(%d)\n",special->byte_width);
    return -1;
    break;
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_u2f_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
  case 1: CONVERT_I2F(double,uint8_t,"%lf","%hhu");
  case 2: CONVERT_I2F(double,uint16_t,"%lf","%hu");
  case 4: CONVERT_I2F(double,uint32_t,"%lf","%u");
  case 8: CONVERT_I2F(double,uint64_t,"%lf","%lu");
  default:
    ERROR("Cannot handle double->unsigned(%d)\n",special->byte_width);
    return -1;
    break;
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_i2f_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) 
{
  switch (special->byte_width) {
  case 1: CONVERT_I2F(float,int8_t,"%lf","%hhd");
  case 2: CONVERT_I2F(float,int16_t,"%lf","%hd");
  case 4: CONVERT_I2F(float,int32_t,"%lf","%d");
  case 8: CONVERT_I2F(float,int64_t,"%lf","%ld");
  default:
    ERROR("Cannot handle float->signed(%d)\n",special->byte_width);
    return -1;
    break;
...
// THIS DOES NOT HANDLE THE SPECIAL CASES OR RAISE EXCEPTIONS
int vanilla_u2f_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
  case 1: CONVERT_I2F(float,uint8_t,"%lf","%hhu");
  case 2: CONVERT_I2F(float,uint16_t,"%lf","%hu");
  case 4: CONVERT_I2F(float,uint32_t,"%lf","%u");
  case 8: CONVERT_I2F(float,uint64_t,"%lf","%lu");
  default:
    ERROR("Cannot handle float->unsigned(%d)\n",special->byte_width);
    return -1;
    break;
...
int vanilla_f2f_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
...
int vanilla_f2f_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
  switch (special->byte_width) {
...
int vanilla_cmp_double(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4)
{
...
int vanilla_cmp_float(op_special_t *special, void *dest, void *src1, void *src2, void *src3, void *src4) 
{
  float a = *(float*)src1;
  float b = *(float*)src2;
  uint64_t *rflags = special->rflags;
