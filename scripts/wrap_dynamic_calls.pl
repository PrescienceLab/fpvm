...
$demote_regs = "fpvm_demote_machine_registers";
...
foreach $func (@funcs) {
    ...
    print S "  orl $mxcsr_in\@GOTPCREL(%rip), %r11d\n";
    print S "  movl %r11d, (%rsp)\n";
    print S "  ldmxcsr (%rsp)\n"; # turn off FP traps                                         
    print S "  call *$demote_regs\@GOTPCREL(%rip)\n";
    print S "  movq $preorig$func\@GOTPCREL(%rip), %r11\n";
    print S "  call *%r11\n";   # invoke original function
    print S "  stmxcsr (%rsp)\n"; # must be in an m32... 
    print S "  movl (%rsp),%r11d\n";
    print S "  andl $mxcsr_out\@GOTPCREL(%rip), %r11d\n";
    print S "  movl %r11d, (%rsp)\n";
    print S "  ldmxcsr (%rsp)\n"; # turn on FP traps                                         
