...
INC_DIRS := include/ $(ARCHINCDIR)/ $(LIGHTNING_LIB)/include/
...
$(TARGET): $(BUILD) $(OBJS) 
	...
	@$(CC) $(CFLAGS) -fPIC -shared $(OBJS) -o $(TARGET) -Wl,-rpath -Wl,$(LIGHTNING_LIB)/lib -lmpfr -lm -ldl -lstdc++ -lcapstone -L$(LIGHTNING_LIB)/lib -llightning
